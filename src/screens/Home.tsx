        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg">
              ...
              <p className="text-green-600 text-sm">Plan your weekly meals and track your nutrition</p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg">
              <h3 className="font-semibold text-purple-800 mb-2">Grocery List</h3>
              <p className="text-purple-600 text-sm">Generate shopping lists from your meal plans</p>
            </div>
          </div>
        </div>
      </div>
